...
void FRemoveDataSuccessDelegate_DelegateWrapper(const FMulticastScriptDelegate& RemoveDataSuccessDelegate, EGJErrors Error)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URemove_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_URemove_RemoveData, "RemoveData" }, // 3618137471
	};
	...
	URemove::~URemove() {}
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_Remove_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_Remove_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemove, URemove::StaticClass, TEXT("URemove"), &Z_Registration_Info_UClass_URemove, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemove), 1615898625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_Remove_h_2447123241(TEXT("/Script/GameJoltAPI"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_Remove_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_Remove_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
