...
void FGetKeysSuccessDelegate_DelegateWrapper(const FMulticastScriptDelegate& GetKeysSuccessDelegate, EGJErrors Error, TArray<FString> const& Keys)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGetKeys_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UGetKeys_GetKeys, "GetKeys" }, // 1742998643
	};
	...
	UGetKeys::~UGetKeys() {}
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_GetKeys_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_GetKeys_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGetKeys, UGetKeys::StaticClass, TEXT("UGetKeys"), &Z_Registration_Info_UClass_UGetKeys, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGetKeys), 1660902863U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_GetKeys_h_2021877800(TEXT("/Script/GameJoltAPI"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_GetKeys_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Data_Store_GetKeys_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
