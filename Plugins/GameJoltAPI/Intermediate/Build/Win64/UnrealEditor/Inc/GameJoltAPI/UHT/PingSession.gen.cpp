...
void FPingSessionSuccessDelegate_DelegateWrapper(const FMulticastScriptDelegate& PingSessionSuccessDelegate, EGJErrors Error)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPingSession_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UPingSession_PingSession, "PingSession" }, // 478819791
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Sessions_PingSession_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Sessions_PingSession_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPingSession, UPingSession::StaticClass, TEXT("UPingSession"), &Z_Registration_Info_UClass_UPingSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPingSession), 3802460412U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Sessions_PingSession_h_2909563137(TEXT("/Script/GameJoltAPI"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Sessions_PingSession_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GameJoltAPI_Source_GameJoltAPI_Public_AsyncActions_Sessions_PingSession_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
